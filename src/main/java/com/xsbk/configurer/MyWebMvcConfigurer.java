...
import com.xsbk.core.Result;
import com.xsbk.core.ResultCode;
import com.xsbk.core.ServiceException;
...
public class MyWebMvcConfigurer implements WebMvcConfigurer {
    ...
    /**
     * @Description:当前激活的配置文件
     * @param:
     * @return:
     * @auther: sxd
     * @date: 3/24/2020 10:27 PM
     */
                ...
                if (!CollectionUtils.isEmpty(objectErrors)) {
                    ...
                    for (ObjectError objectError : objectErrors) {
                        if (objectError instanceof FieldError) {
                            ...
                            msgBuilder.append("{");
                            msgBuilder.append(fieldError.getField()).append(" = ").append(fieldError.getRejectedValue()).append(" , ").append("msg = ");
